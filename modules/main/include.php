...
/*ZDUyZmZMDY0ZmQzYzU3YzM4ZTcyZGYzNWMyNzRjNTlhODQ4MzA=*/$GLOBALS['____280154873']= array(base64_decode('ZG'.'V'.'maW5l'));if(!function_exists(__NAMESPACE__.'\\___1216809236')){function ___1216809236($_2024127883){static $_432375885= false; if($_432375885 == false) $_432375885=array(''.'RU'.'5D'.'T'.'0RF','WQ==');return base64_decode($_432375885[$_2024127883]);}};class CBXFeatures{ public static function IsFeatureEnabled($_749424741){ return true;} public static function IsFeatureEditable($_749424741){ return true;} public static function SetFeatureEnabled($_749424741, $_2039590193= true){} public static function SaveFeaturesSettings($_1760956981, $_1430923247){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_1353684609){} public static function ModifyFeaturesSettings($_1353684609, $_93671828){} public static function IsFeatureInstalled($_749424741){ return true;}} $GLOBALS['____280154873'][0](___1216809236(0), ___1216809236(1));/**/			//Do not remove this
